...
idealGroupMean = 0.44 #0.65
idealGroupSD =0.04  #0.07
idealNsubj = 40 #100       # more subjects => higher confidence in hypothesis
idealNtrlPerSubj = 100 #100 # more trials => higher confidence in hypothesis
...
# Load actual data
idealDatFrm = read.csv("TherapeuticTouchData.csv")
