...
saveGraph(file="Figures/BernGridExample0",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="None" , showHDI=FALSE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample1",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="None" , showHDI=FALSE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample2",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="None" , showHDI=FALSE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample3",type="eps")
#------------------------------------------------------------------------------
...
saveGraph(file="Figures/BernGridExample4",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="Mode" , showHDI=TRUE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample5",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="Mode" , showHDI=TRUE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample6",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="Mode" , showHDI=TRUE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample7",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="Mode" , showHDI=TRUE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample8",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="Mode" , showHDI=TRUE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample9",type="eps")
#------------------------------------------------------------------------------
...
posterior = BernGrid( Theta, pTheta , Data , plotType="Bars" , 
                      showCentTend="None" , showHDI=FALSE , showpD=FALSE )
saveGraph(file="Figures/BernGridExample10",type="eps")
#------------------------------------------------------------------------------
