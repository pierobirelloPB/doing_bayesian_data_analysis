...
require(rjags)
fileNameRoot="Figures/Selection/Prev2-Jags-Ydich-Xnom1subj-MbernBetaModelComp-" # for output filenames
...
openGraph(width=7,height=5)
plotPost(theta, 
         main="Posterior of theta collapsed across models", 
         xlab=expression(theta), 
         xlim=c(0,1))
saveGraph( file=paste0(fileNameRoot,"PostCollapsed") , type="eps" )
